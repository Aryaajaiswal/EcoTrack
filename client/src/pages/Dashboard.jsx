...
export default function Dashboard() {
  ...
  const dailyChart = {
    ...
    datasets: [{
      ...
      backgroundColor: (analytics?.daily_values || [8,6,9,7,11,5,8]).map((_, i, arr) =>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          {[
            {
              title: 'Carbon Score',
              value: lastCalc ? (lastCalc.total_co2_kg_per_year >= 1000 ? (lastCalc.total_co2_kg_per_year / 1000).toFixed(1) : Math.round(lastCalc.total_co2_kg_per_year).toLocaleString()) : '—',
              unit: lastCalc ? (lastCalc.total_co2_kg_per_year >= 1000 ? 'tonnes/yr' : 'kg/yr') : '',
            ...
            {
              title: 'CO₂ Saved',
              value: user?.total_carbon_saved >= 1000 ? (user.total_carbon_saved / 1000).toFixed(1) : Math.round(user?.total_carbon_saved || 0).toLocaleString(),
              unit: user?.total_carbon_saved >= 1000 ? 'tonnes' : 'kg',
