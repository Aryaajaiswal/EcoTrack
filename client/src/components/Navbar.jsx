...
import { Leaf, Menu, X, BarChart2, Zap, Trophy, User, LogOut, Calculator, TrendingUp, Award, Users, Shield } from 'lucide-react'
        ...
        <div className="flex items-center justify-between h-16">
          ...
          {isAuthenticated && (
            <div className="hidden md:flex items-center gap-2">
              <NotificationBell />
              {user?.is_admin && (
                <Link to="/admin" className="p-2 text-gray-400 hover:text-emerald-400 rounded-lg hover:bg-emerald-500/10 transition-all">
